...
const Hero = () => {
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        // The URL now only includes the location for the house search
        navigate(`/houses?location=${location}`);
    };
            ...
            >
                ...
                <div className='flex flex-col md:flex-row items-start md:items-center gap-10 min-md:ml-8'>
                    <div className='flex flex-col items-start gap-2'>
                        ...
                        <p className='px-1 text-sm text-gray-500'>{location ? location : 'Please select a location'}</p>
                    </div>
                </div>
