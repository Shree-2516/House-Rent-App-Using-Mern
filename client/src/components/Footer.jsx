    ...
    >
      ...
      >
        ...
        <div>
          ...
          <h1 className='text-xl font-bold text-gray-800'>House Rental</h1>
          ...
          >
            Premium house rental service with a wide selection of luxury homes, apartments, and vacation stays for all your living needs.
          </motion.p>
        ...
        >
          ...
          <div>
            ...
            <ul className='mt-3 flex flex-col gap-1.5'>
              <li><a href="#">Home</a></li>
              <li><a href="#">Browse Houses</a></li>
              <li><a href="#">List Your House</a></li>
          ...
          <div>
            ...
            <ul className='mt-3 flex flex-col gap-1.5'>
              <li>416101 - Kolhapur</li>
              <li>Kolhapur</li>
              <li>+1 234 567890</li>
              <li>shree@gmmail.com</li>
            </ul>
          </div>
      ...
      >
        <p>© {new Date().getFullYear()} Shreeyash All rights reserved.</p>
